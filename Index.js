...
function descriptionTooLong(){
    var labDescription = document.getElementById('lab_description').value
    if(labDescription.length<48){
      return [labDescription.slice(0,24).toUpperCase(),labDescription.slice(24).toUpperCase()]
    }else{
...
function updateXML(){
  var descriptionLines = descriptionTooLong()
  ...
  <DieCutLabel Version="8.0" Units="twips" MediaType="Default">\
    ...
    <TextObject>\
      ...
      <StyledText>\
        <Element>\
        <String>'+document.getElementById('patient_name').value.toUpperCase()+'\n'+
        '</String>\
          <Attributes>\
    ...
    <Bounds X="0" Y="2700" Width="5710" Height="400"/>\
    </ObjectInfo>\
    \
    <ObjectInfo>\
      <TextObject>\
      ...
      <Bounds X="350" Y="500" Width="1500" Height="3500"/>\
    </ObjectInfo>\
    <ObjectInfo>\
      <TextObject>\
        <Name>TEXT_2</Name>\
      ...
      <Bounds X="2000" Y="500" Width="3550" Height="3500"/>\
    </ObjectInfo>\
    <ObjectInfo>\
      <ImageObject>\
      ...
      <Bounds X="0" Y="150" Width="5715" Height="120" />\
    </ObjectInfo>\
  </DieCutLabel>';
}
...
function dateToNA(passedInValue){
    ...
    return scanorInsertDate(passedInValue)
}
...
function scanorInsertDate(date){
...
function convertDataToObject(){
    ...
    let insertTime = document.getElementById('scan_time').value;
